...
public record OpenAiSettings()
{
    ...
    public required string RecipeExtractionPrompt { get; init; } =
        "You are a helpful recipe assistant. Extract up to 2 recipes for a full meal from the attached image(s). " +
    ...
    public required string RecipeImageExtractionPrompt { get; init; } = "Create a realistic professional magazine photo of the dish \"{0}\". Show the meal as it would be served, beautifully presented on a plate.";
};